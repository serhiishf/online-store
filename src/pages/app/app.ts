...
class App {
  ...
  run() {
    // alert('Доброжелательный проверяющий! Прошу проверить задание в четверг, Заранее спасибо!');
    console.log('Доброжелательный проверяющий! Прошу проверить задание в четверг, Заранее спасибо!');
    this.router();
  }
}
